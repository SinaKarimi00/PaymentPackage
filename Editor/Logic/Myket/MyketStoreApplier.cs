...
namespace Mirka.Payment.Editor.Editor.Logic.Myket
{
    public static class MyketStoreApplier
    {
        ...
        {
            FileTools.SetFileHidden("Packages/PaymentPackage-0.1.4/Packages/.MyketIAB", false);
            FileTools.SetFileHidden("Packages/PaymentPackage-0.1.4/Plugins/Android/.MyketIAB.jar", false);
        }
    }
}
#endif